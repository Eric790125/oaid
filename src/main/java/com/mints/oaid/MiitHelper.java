...
public class MiitHelper implements IIdentifierListener {
    ...
    public static final int HELPER_VERSION_CODE = 20230202; // DemoHelper版本号
    private final AppIdsUpdater appIdsUpdater;
    private boolean isCertInit = false;

    public boolean isSDKLogOn = true;          // TODO （1）设置 是否开启sdk日志
    public static final String ASSET_FILE_NAME_CERT = "com.duben.roseplaylet.cert.pem";  // TODO （2）设置 asset证书文件名
    ...
    public void getDeviceIds(Context cxt, boolean isGetOAID, boolean isGetVAID, boolean isGetAAID) {
        ...
        // TODO （5）调用SDK获取ID
        int code = MdidSdkHelper.InitSdk(cxt, isSDKLogOn, isGetOAID, isGetVAID, isGetAAID, this);
